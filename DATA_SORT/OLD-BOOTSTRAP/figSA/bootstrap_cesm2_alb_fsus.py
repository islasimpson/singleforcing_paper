...
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/BOOTSTRAP/figSA/"
...
aer2_fsns = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/LENS2-SF/"+\
           "AAER_FSNS_djf.nc", preprocess=partial(preprocessor)).FSNS
aer2_fsds = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/LENS2-SF/"+\
           "AAER_FSDS_djf.nc", preprocess=partial(preprocessor)).FSDS

aer_fsus = aer2_fsds - aer2_fsns
aer_fsus_gm = avg.cosweightlonlat(aer_fsus, 0, 360, -90, -50)
aer_fsds_gm = avg.cosweightlonlat(aer2_fsds, 0, 360, -90, -50)
