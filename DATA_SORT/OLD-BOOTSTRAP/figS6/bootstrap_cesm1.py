...
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/BOOTSTRAP/figS6/"

varnames=['TREFHT','ICEFRAC','FSNO']
...
for ivar in varnames:
    ...
    xaer1 = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
        "LENS1-SF/XAER_"+ivar+"_jja.nc", preprocess=partial(preprocessor))
    lens1 = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
        "LENS1/LENS1_"+ivar+"_jja.nc", preprocess=partial(preprocessor))
    ...
    xaer1gmt = avg.cosweightlonlat(xaer1[ivar],0,360,50,90)
    xaer1gm = calc21ymean(xaer1gmt)

    lens1gmt = avg.cosweightlonlat(lens1[ivar],0,360,50,90)
