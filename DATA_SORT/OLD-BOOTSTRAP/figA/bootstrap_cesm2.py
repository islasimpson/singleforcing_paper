...
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/BOOTSTRAP/figA/"

varnames=['BURDENBCdn','BURDENSO4dn']
...
for ivar in varnames:
    ...
    aer2gm = avg.cosweightlonlat(aer2[ivar],0,360,-90,90)
