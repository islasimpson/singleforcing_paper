...
basepath="/project/cas/islas/python_savs/singleforcing_paper/EMISSIONS/CESM2/BMB_standard/"
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/FORCINGS/"

#---------------------------------------------------------------------------------
#-----------------------------Black Carbon----------------------------------------
#---------------------------------------------------------------------------------
bmb_bc = xr.open_dataset(basepath+'BC/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_bc_a4_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc')
...
#--------------------------------DMS----------------------------------------------
#---------------------------------------------------------------------------------
bmb_dms = xr.open_dataset(basepath+'DMS/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_DMS_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc')
...
#---------------------------------pom---------------------------------------------
#---------------------------------------------------------------------------------
bmb_pom = xr.open_dataset(basepath+'/pom/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_pom_a4_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc')
...
#---------------------------------SO2---------------------------------------------
#---------------------------------------------------------------------------------
bmb_so2 = xr.open_dataset(basepath+'/SO2/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_SO2_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc')
...
#---------------------------------SO4---------------------------------------------
#---------------------------------------------------------------------------------
bmb_so4 = xr.open_dataset(basepath+'/SO4/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_so4_a1_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc')
...
#---------------------------------SOAG---------------------------------------------
#---------------------------------------------------------------------------------
bmb_soag = xr.open_dataset(basepath+'/SOAG/srf/'+\
'emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_SOAGx1.5_bb_surface_mol_175001-210101_0.9x1.25_c20200403.nc')
...
bmb_bc_tg.to_netcdf(pathout+'BMB_standard.nc')
bmb_dms_tg.to_netcdf(pathout+'BMB_standard.nc', mode='a')
bmb_pom_tg.to_netcdf(pathout+'BMB_standard.nc', mode='a')
bmb_so2_tg.to_netcdf(pathout+'BMB_standard.nc', mode='a')
bmb_so4_tg.to_netcdf(pathout+'BMB_standard.nc', mode='a')
bmb_soag_tg.to_netcdf(pathout+'BMB_standard.nc', mode='a')
