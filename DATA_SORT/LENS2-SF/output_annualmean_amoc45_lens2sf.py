...
#amoc.to_netcdf(pathout+'GHG_AMOC45_am.nc')
#----------
...
#dat = dat.groupby('time.year').mean('time').compute()
#amoc = modes.calcAMOC(dat.MOC, lat=45)
#amoc.to_netcdf(pathout+'AAER_AMOC45_am.nc')
#----------
...
dat = dat.groupby('time.year').mean('time').compute()
amoc = modes.calcAMOC(dat.MOC, lat=45)
amoc.to_netcdf(pathout+'BMB_AMOC45_am.nc')
##----------
#
##-------EE
...
dat = dat.groupby('time.year').mean('time').compute()
amoc = modes.calcAMOC(dat.MOC, lat=45)
amoc.to_netcdf(pathout+'EE_AMOC45_am.nc')
