...
for varname in varnames:
    ...
    dat.to_netcdf(pathout+'GHG_'+varname+'_ensemblemean_allmonths.nc')
    ...
    dat = dat[varname]
    dat = dat.mean('M').compute()
    dat.to_netcdf(pathout+'BMB_'+varname+'_ensemblemean_allmonths.nc')
    ...
    dat = dat[varname]
    dat = dat.mean('M').compute()
    dat.to_netcdf(pathout+'EE_'+varname+'_ensemblemean_allmonths.nc')
