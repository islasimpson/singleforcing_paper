...
topdir="/project/mojave/cesm2/LENS/lnd/month_1/"
...
for varname in varnames:
    ...
    filelist=[sorted(glob.glob(topdir+varname+"/*.BHISTsmbb.*"+imem+"*.nc"))+
              ...
              for imem in memstr ]
    members = [xr.open_mfdataset(i, combine='nested', concat_dim=['time'], coords='minimal',
                   data_vars=[varname,'time_bounds'], compat='override')[[varname,'time_bounds']] for i in filelist]
