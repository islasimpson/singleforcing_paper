...
topdir="/project/mojave/cesm1/LENS/atm/month_1/BURDENSO4/"
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/piControl/CESM1/"

trefht = xr.open_mfdataset(topdir+'b.e11.B1850C5CN.f09_g16.005*210001-220012.nc', 
           decode_times='False', data_vars=['BURDENSO4', 'time_bnds'])
...
trefhtam.to_netcdf(pathout+'picontrol_BURDENSO4_am.nc')
