...
pi_amoc = pi_amoc.isel(year=slice(400,pi_amoc.year.size))
...
pi_fsus = pi_fsus.isel(year=slice(400,pi_fsus.year.size))
...
#amocboot['year'] = np.arange(0,1600,1)
...
#fsusboot['year']  = np.arange(0,1600,1)
