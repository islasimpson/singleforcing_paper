...
pathout="/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/BOOTSTRAP/figS13/"
...
xaer1_fsns = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
       "LENS1-SF/XAER_FSNS_djf.nc", preprocess=partial(preprocessor)).FSNS
xaer1_fsds = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
       "LENS1-SF/XAER_FSDS_djf.nc", preprocess=partial(preprocessor)).FSDS
xaer1_fsus = xaer1_fsds - xaer1_fsns

lens1_fsns = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
       "LENS1/LENS1_FSNS_djf.nc", preprocess=partial(preprocessor)).FSNS
lens1_fsds = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/"+
       "LENS1/LENS1_FSDS_djf.nc", preprocess=partial(preprocessor)).FSDS
lens1_fsus = lens1_fsds - lens1_fsns

xaer1_fsus_gm = avg.cosweightlonlat(xaer1_fsus, 0, 360, -90, -50)
xaer1_fsds_gm = avg.cosweightlonlat(xaer1_fsds, 0, 360, -90, -50)
xaer1_alb = xaer1_fsus_gm / xaer1_fsds_gm

lens1_fsus_gm = avg.cosweightlonlat(lens1_fsus, 0, 360, -90, -50)
lens1_fsds_gm = avg.cosweightlonlat(lens1_fsds, 0, 360, -90, -50)
