...
aer2_fsns = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/LENS2-SF/"+\
           "AAER_FSNS_am.nc", preprocess=partial(preprocessor)).FSNS
aer2_fsds = xr.open_mfdataset("/project/cas/islas/python_savs/singleforcing_paper/DATA_SORT/LENS2-SF/"+\
           "AAER_FSDS_am.nc", preprocess=partial(preprocessor)).FSDS

aer_fsus = aer2_fsds - aer2_fsns
aer_fsus_gm = avg.cosweightlonlat(aer_fsus, 0, 360, -90, 90)
aer_fsds_gm = avg.cosweightlonlat(aer2_fsds, 0, 360, -90, 90)
...
bootaerfsus = boot.bootgen(aer_fsus_21y, nsamples = aer_fsus_21y.M.size, seed=4, nboots=1000)
bootaeralb3 = boot.bootgen(aer_alb_21y, nsamples = 3, seed=5, nboots=1000)
bootaerfsus3 = boot.bootgen(aer_fsus_21y, nsamples = 3, seed=6, nboots=1000)
